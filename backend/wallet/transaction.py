...
class Transaction:
    ...
    def create_input(self, sender_wallet, output):
        """
        Structure the inpute data for the transaction.
        Sign the transaction. and inclued the sender's
        publick and key address
        """
    ...
    def is_valid_transaction(transaction):
        """
        Validet a trnsaction.
        Raise an exception for invalide transactions.
        """
